...
export const RED_BULL_SCENARIO: Scenario = {
  ...
  prePosts: [
    ...
    { type: "post", name: "RockerPoweredMohawk", handle: "@RPM_racing", av: "creator", initials: "RP", creator: true, text: "new vid up! ranking every team's chances this season. spoiler: it's not looking close at the front... yet 👀 link below", likes: 34200, rts: 8800, platform: "MockTube" },
  ...
  sections: [
    ...
    },
    {
      ...
      posts: [
        ...
        { type: "post", name: "RockerPoweredMohawk", handle: "@RPM_racing", av: "creator", initials: "RP", creator: true, text: "right, my comments are FULL of people treating leaked screenshots as gospel. I need to say this clearly: WE DO NOT KNOW IF ANY OF THIS IS REAL. I'm not platforming unverified files on my channel. the story is real, the power struggle is real, but half this 'evidence' is cooked. do better 🙏 #HorndogFiles", likes: 96200, rts: 52400, platform: "MockTube" },
      ],
    },
    {
